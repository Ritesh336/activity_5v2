                ...
                children: [
                  Container(
                    ...
                    child: happinessLevel < 30 ? const Image(image: AssetImage("assets/sad.png"))
                      : happinessLevel > 70 ? const Image(image: AssetImage("assets/happy.png"))
                      : (happinessLevel >= 30 && happinessLevel < 50) ? const Image(image: AssetImage("assets/angry.png"),) 
                      : const Image(image: AssetImage("assets/dog.png")),
                  ),
                  const SizedBox(
                    width: 30,
                  ),
